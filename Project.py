...
def deleteUser():
    ...
    del user_data["username"][user_to_delete_index]
    del user_data["role"][user_to_delete_index]
    del user_data["password"][user_to_delete_index]
    del user_data["balance"][user_to_delete_index]
